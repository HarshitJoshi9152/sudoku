...
class Render
{
    ...
    renderValueInPlace = function(val, { x:x, y:y }, edit=false) 
    {
        ...
        (edit == true) ? this.ctx.clearRect(x + this.ctx.lineWidth, y + this.ctx.lineWidth, this.unit - this.ctx.lineWidth, this.unit - this.ctx.lineWidth) : null;
